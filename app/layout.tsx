...
const publicBaseUrl = configuredSiteUrl ? new URL(configuredSiteUrl) : undefined;
const socialImageUrl = publicBaseUrl ? new URL('/og.png', publicBaseUrl).toString() : undefined;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: socialImageUrl ? [{ url: socialImageUrl, width: 1730, height: 909, alt: 'When Controls Raise the Cost research project' }] : undefined,
  },
  twitter: {
